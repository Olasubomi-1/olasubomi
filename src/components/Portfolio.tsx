...
const categories = [
  {
    ...
    assets: [
      ...
      { id: 2, iframe: "https://www.youtube.com/embed/1W5_S4bKJ-Y?autoplay=1&mute=1&loop=1&playlist=1W5_S4bKJ-Y", title: "AI UGC Content" },
  ...
  // HIDDEN: Creative Design category - uncomment to re-enable
  // {
  //   id: "creative-design",
